...
guard :minitest, all_on_start: false do
  ...
  watch('app/views/layoute/application.html.erb') do
  ...
  watch('app/controllers/sessions_controller.rb') do
    ['test/controllers/sessions_controller.rb',
...
# Returns the integration stest corresponding to the given resource.
